<div class="mt-2">
                            ...
                            <div class="px-4 py-6 bg-indigo-700 sm:px-6">
                                ...
                                <div class="mt-1">
                                    <p class="text-sm text-indigo-300">
                                        Completa el formulario con los cambios de información del usuario.
                                    </p>
                                </div>
                            </div>
    ...
    <x-notifications.modal-confirmacion-finalizar>
        <h3 class="text-lg font-semibold leading-6 text-gray-900" id="modal-title">¡Usuario actualizado exitosamente!</h3>
        <div class="mt-2">
        </div>
    </x-notifications.modal-confirmacion-finalizar>
