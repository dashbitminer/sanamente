<div class="px-4 sm:px-0 text-dark-gray" >
                    ...
                    <div class="sm:col-span-full">
                        ...
                        <div class="mt-2 pl-2">
                            <div class="flex grid-cols-2 gap-6 flex-col sm:flex-row">
                                <x-ref-input-label class="flex items-center gap-4 h-12 sm:text-lg" for="form.iniciar_proceso_referencia_1">
                                ...
                                <x-ref-input-label class="flex items-center gap-4 h-12 sm:text-lg" for="form.iniciar_proceso_referencia_0">
                                    <x-forms.input-radio type="radio" wire:model="form.iniciar_proceso_referencia"
    ...
    <x-notifications.modal-confirmacion-finalizar>
        ...
        <div class="mt-2">
            @if($form->iniciar_proceso_referencia == 1)
                <p class="text-lg text-dark-gray">Gracias  for completar el proceso, su código de
                confirmación es: <span class="font-semibold">{{ $codigo_confirmacion }}</span>  </p>
            @else
                <p class="text-lg text-dark-gray">Gracias  for completar el proceso.</p>
            @endif
        </div>
    </x-notifications.modal-confirmacion-finalizar>
