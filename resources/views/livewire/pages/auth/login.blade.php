...
<div>
    ...
    @if (config('app.GW_ENV') === 'DEV')
        <div class="p-4 mb-4 text-yellow-700 bg-yellow-100 border-l-4 border-yellow-500" role="alert">
            <p class="font-bold text-center">SITIO DE PRUEBAS</p>
            <p>Este sitio debe de usarse unicamente para realizar pruebas de funcionalidades o familiarizarse con el sistema, la información que se guarde acá no se verá reflejada en el sitio de producción.</p>
        </div>
    @endif
