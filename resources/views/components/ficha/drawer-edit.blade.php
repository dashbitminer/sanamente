@props([
    ...
    'ultimosGrados' => [],
    'discapacidades' => [],
    'form', 'departamentos', 'nivelesAcademicos', 'secciones', 'turnos', 'ficha', 'departamentosReside',
    'municipiosreside' => [],
    'ciudades' => [],
    'escuelas' => [],
    'labels' => []
                            ...
                            <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                ...
                                x-show="$wire.form.deseo_participar == 1
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="px-4 py-3">
                                            <div class="flex grid-cols-2 gap-6 flex-col sm:flex-row">
                                                <x-input-label class="flex items-center gap-4 h-12 text-sm/6" for="form.encuentras_estudiando_1">
                                                ...
                                                <x-input-label class="flex items-center gap-4 h-12 text-sm/6" for="form.encuentras_estudiando_0">
                                                    <x-forms.input-radio type="radio" wire:model="form.encuentras_estudiando"
                                    ...
                                    <div class="sm:col-span-3" >
                                        ...
                                        <div class="mt-2">
                                            <x-forms.single-select name="form.sede_id" wire:model='form.sede_id' id="form.sede_id"
                                                disabled="{{ $form->readonly ? 'disabled' : '' }}" 
                                    ...
                                    <div class="sm:col-span-3" x-show="$wire.form.encuentras_estudiando == 1">
                                        <x-input-label class="text-sm/6" for="form.actividad_club_id">{{ __('Selecciona el club/actividad en que participaras este año:') }}
                                            <x-required-label />
                                        </x-input-label>
                                        <div class="mt-2">
                                            <x-forms.single-select name="form.actividad_club" wire:model='form.actividad_club_id' id="form.actividad_club_id"
                                                disabled="{{ $form->readonly ? 'disabled' : '' }}" 
                                                :options="[]" selected="Seleccione una opción" @class([ 'h-12 text-sm/6',
                                                    'block w-full mt-1','border-2 border-red-500' => $errors->has('form.actividad_club_id'),
                                                    'disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none' => $form->readonly,
                                                ]) />
                                            <x-input-error :messages="$errors->get('form.actividad_club_id')" class="mt-2" aria-live="assertive" />
                                        </div>
                                    </div>
