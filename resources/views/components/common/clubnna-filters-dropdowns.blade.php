@props(['departamentos', 'ciudades' => [], 'escuelas' => [], 'filters', 'escuelaSelected', 'labels' => []])

<div class="grid grid-cols-1 gap-2 mt-6 sm:grid-cols-5 sm:mt-0">
    <div class="col-span-1 sm:col-span-1">
        <label for="filter1" class="block mb-2 text-sm font-medium text-gray-700">{{ $labels['departamento_label'] }}</label>
    ...
    <div class="col-span-1 sm:col-span-1">
        <label for="filter2" class="block mb-2 text-sm font-medium text-gray-700">Municipio</label>
    ...
    <div class="col-span-1 sm:col-span-2">
        <label for="filter3" class="block mb-2 text-sm font-medium text-gray-700">Sede</label>
        <flux:select variant="listbox" multiple searchable clear="close" selected-suffix="seleccionados"
