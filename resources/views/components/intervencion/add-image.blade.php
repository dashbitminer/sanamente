...
<button wire:click="{{ $click }}"
    type="button"
    class="flex gap-1 justify-center content-center relative w-full px-8 py-3 font-medium text-white bg-indigo-600 rounded-lg text-uppercase disabled:cursor-not-allowed disabled:opacity-75 hover:bg-indigo-500">
    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M18.5 3V5.5M18.5 8V5.5M18.5 5.5H16M18.5 5.5H21" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    Agregar otra imagen
</button>
