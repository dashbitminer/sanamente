...
class SeguimientoFormacionPoliciaForm extends Form
{
    public Pais $pais;

    public SeguimientoFormacionGeneral $seguimiento;

    public $perfilSelected = PerfilSeguimiento::PERFIL_POLICIA;
    public $perfilSelectedPivot = 11;
    ...
    public $nombres;
    public $apellidos;
    public $documento_identidad_policia;
    public $nacionalidad;
    public $participacion_policia;
    ...
    public $documento_identidad = false; // use this to avoid collition and use the same trait InitializeForm;
    ...
    public function rules()
    {
        return [
            ...
            'participacion_policia' => [
               'required',
            ],
            'documento_identidad_policia' => [
                'required',
    ...
    public function messages()
    {
        return [
            ...
            'participacion_policia.required' => 'El campo participación es requerido.',
            ...
            'documento_identidad_policia.required' => 'El campo documento de identidad es requerido.',
    ...
    public function init($pais, $uuid, $email)
    {
        ...
        $this->user = \App\Models\User::where('uuid', $uuid)
            ->where('email', $email)
            ->firstOrFail();
    ...
    public function setFormulario($formulario)
    {
        ...
        $this->documento_identidad_policia =  substr($formulario->documento_identidad, -4);



        $this->participacion_policia = $formulario->participacion;
    ...
    public function save(?SeguimientoFormacionGeneral $seguimiento = null)
    {
        ...
        DB::transaction(function () {
            ...
            $escuela = EscuelaGWDATA::find($this->escuelaSelected);
            ...
            $this->seguimiento->documento_identidad = strtoupper($shortName).'/'.$codigoEscuela.'/'.$this->documento_identidad_policia;

            $this->seguimiento->participacion = $this->participacion_policia;

            $this->seguimiento->nacionalidad = $this->nacionalidad;

            // $seguimiento->pais_perfil_seguimiento_id = $this->getPaisPerfilSelected();
            ...
            if ($this->mode != "edit") {
                ...
                $this->pull(['nombres', 'apellidos', 'documento_identidad', 'documento_identidad_policia', 'perfilSelected', 'perfilSelectedPivot', 'perfilDocenteSelected', 'perfilPoliciaSelected', 'rangoPoliciaSelected', 'perfilOrganizacionSelected', 'perfilSaludSelected', 'perfilHospitalSelected', 'departamentoSelected', 'ciudadSelected', 'escuelaSelected', 'numero_grupo_participa', 'participacion', 'nacionalidad']);
    ...
    //            // $this->numero_grupo_participa = $latestRecord->numero_grupo_participa;
