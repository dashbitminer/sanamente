...
use App\Livewire\FRP\Forms\SeguimientoReferenciaParticipanteForm;
...
class Seguimiento extends Component {
    use WithFormUtility;
    public SeguimientoReferenciaParticipanteForm $form;
    ...
    public function render()
    {
        ...
        return view('livewire.FRP.edit.seguimiento', $this->form->getData());
    }
